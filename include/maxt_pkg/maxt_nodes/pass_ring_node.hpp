#ifndef MAXT_NODES_PASS_RING_HPP
#define MAXT_NODES_PASS_RING_HPP
...
class RingPassNode : public MavActionNode {
public:
    RingPassNode(const std::string& name, const BT::NodeConfiguration& config, MavKit& mav);
